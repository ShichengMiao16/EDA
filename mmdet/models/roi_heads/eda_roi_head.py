...
class EDARoIHead(OBBStandardRoIHead):
    """ RoI head for EDA
    """
    def forward_dummy(self, x, proposals):
        ...
        if self.with_bbox:
            ...
            outs = outs + (bbox_results['cls_score'],
                           ...
                           bbox_results['bin_cls_pred'],
                           bbox_results['bin_offset_pred'],
    ...
    def _bbox_forward(self, x, rois):
        ...
        (cls_score, bbox_pred, bin_cls_pred, 
            bin_offset_pred, ratio_pred) = outputs
        bbox_results = dict(
            cls_score=cls_score, bbox_pred=bbox_pred,
            bin_cls_pred=bin_cls_pred, bin_offset_pred=bin_offset_pred,
            ratio_pred=ratio_pred, bbox_feats=bbox_feats)
        return bbox_results
